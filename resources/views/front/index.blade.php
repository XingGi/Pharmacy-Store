	...
	<body>
		...
		<section class="wrapper flex flex-col gap-2.5 items-center justify-center">
			...
			<form action="{{ route('front.search') }}" method="GET" id="searchForm" class="w-full">
				<input type="text" name="keyword" id="searchProduct" style="background-image: url({{ asset('assets/svgs/ic-search.svg') }})"
		...
		<section class="wrapper">
			<div style="background-image: url('{{ asset('assets/svgs/doctor-help.svg') }}')"
				...
				<div class="flex flex-col gap-4 mb-[23px]">
					...
					<a href="#" class="rounded-full bg-white text-primary flex w-max gap-2.5 px-6 py-2 justify-center items-center text-base font-bold">
						Explore
					</a>
				</div>
			</div>
